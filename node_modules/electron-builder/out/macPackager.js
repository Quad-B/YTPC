...
class MacPackager extends (_platformPackager || _load_platformPackager()).PlatformPackager {
    ...
    sign(appPath, outDir, masOptions) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            let identity = yield (0, (_codeSign || _load_codeSign()).findIdentity)(isDevelopment ? "Mac Developer" : certificateType, isMas ? masQualifier : qualifier, keychainName);
            if (identity == null) {
                ...
                if (identity == null) {
                    ...
                    const message = (0, (_flags || _load_flags()).isAutoDiscoveryCodeSignIdentity)() ? `App is not signed: cannot find valid "${certificateType}" identity${postfix}, see https://github.com/electron-userland/electron-builder/wiki/Code-Signing` : `App is not signed: env CSC_IDENTITY_AUTO_DISCOVERY is set to false`;
